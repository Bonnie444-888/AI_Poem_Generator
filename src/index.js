...
function generatePoem(event) {
  ...
  let context =
    "You are a romantic Poem expert and love to write short poems. Your mission is to generate a 4 line in basic HTML. Please Do NOT ever include the html title at the top of the poem. Make sure to follow the user instructions. Sign the poem with 'Shecodes AI' inside a <strong> element";
